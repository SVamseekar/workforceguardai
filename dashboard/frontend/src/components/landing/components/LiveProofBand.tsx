...
export function LiveProofBand() {
  return (
    <section
      className="landing-stats-band landing-reveal landing-stagger"
      aria-label="Key market and compliance figures"
    >
      <div className="landing-stats-band__inner">
        {LIVE_PROOF_STATS.map((stat) => (
          <div key={stat.label} className="landing-stat landing-stagger__item">
            <AnimatedStatValue display={stat.value} className="landing-stat__value" />
